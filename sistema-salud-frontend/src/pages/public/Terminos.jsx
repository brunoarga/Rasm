  ...
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-12">
      ...
      <div className="mt-6 space-y-5 text-sm leading-relaxed" style={{ color: '#E2E8F0' }}>
        <section>
          <h2 className="text-base font-semibold mb-1" style={{ color: '#FFFFFF' }}>1. Uso de la plataforma</h2>
          <p>
        ...
        <section>
          <h2 className="text-base font-semibold mb-1" style={{ color: '#FFFFFF' }}>2. Alcance del servicio</h2>
          <p>
        ...
        <section>
          <h2 className="text-base font-semibold mb-1" style={{ color: '#FFFFFF' }}>3. Responsabilidad del usuario</h2>
          <p>
        ...
        <section>
          <h2 className="text-base font-semibold mb-1" style={{ color: '#FFFFFF' }}>4. Modificaciones</h2>
          <p>
