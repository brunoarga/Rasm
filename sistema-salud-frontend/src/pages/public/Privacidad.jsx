  ...
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-12">
      ...
      <div className="mt-6 space-y-5 text-sm leading-relaxed" style={{ color: '#6C757D' }}>
        ...
        <section>
          <h2 className="text-base font-semibold mb-1" style={{ color: '#1E2124' }}>2. Confidencialidad clínica</h2>
          <p>
        ...
        <section>
          <h2 className="text-base font-semibold mb-1" style={{ color: '#1E2124' }}>3. Uso de la información</h2>
          <p>
        ...
        <section>
          <h2 className="text-base font-semibold mb-1" style={{ color: '#1E2124' }}>4. Contacto</h2>
          <p>
